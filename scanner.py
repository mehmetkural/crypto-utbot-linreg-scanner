...
----------------------------------------------------------------------
Binance USDT spot piyasasini 2 saatlik (2h) zaman diliminde tarar.
...
TIMEFRAME_ENTRY = "2h"                   # giris (sinyal arama) zaman dilimi
TIMEFRAME_CONFIRM = "2h"                 # onay zaman dilimi (tum parametreler 2 saatlik)
...
CHART_TIMEFRAME = "2h"                   # bildirime eklenen grafigin zaman dilimi
...
def evaluate_symbol(symbol):
    try:
        ...
        # Giris ve onay zaman dilimi ayniysa (varsayilan: ikisi de 2h) ayni veriyi
...
if __name__ == "__main__":
    ...
    if os.environ.get("FORCE_TEST_NOTIFY"):
        ...
        # Sinyal sayisi ne olursa olsun, tum sinyal coinlerinin 2 saatlik mum
        ...
        if notifications_enabled():
            send_ntfy(
                "\n\n".join(lines),
                title=f"{len(signals)} Guclu AL Sinyal (2h UT Bot)",
                priority="high",
                click_url=click_url,
